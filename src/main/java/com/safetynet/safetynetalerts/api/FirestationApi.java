...
/**
 * FirestationApi is the Endpoint interface that will perform the following actions via Get/Post/Put/Delete with HTTP on fire stations.
 * 
 * @author MC
 * @version 1.0
 */
...
public interface FirestationApi {
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PersonInFireStation.class))),
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "Created", content = @Content(mediaType = "application/json", schema = @Schema(implementation = FireStation.class))),
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = FireStation.class))),
