...
/**
 * MedicalRecordApi is the Endpoint interface that will perform the following actions via Post/Put/Delete with HTTP on medical records.
 * 
 * @author MC
 * @version 1.0
 */
...
public interface MedicalRecordApi {
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "Created", content = @Content(mediaType = "application/json", schema = @Schema(implementation = MedicalRecord.class))),
  ...
  @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK", content = @Content(mediaType = "application/json", schema = @Schema(implementation = MedicalRecord.class))),
